...
To do so, first create a AppEEARS Earth Data Cloud user ([here](https://urs.earthdata.nasa.gov/home)) and setup the appeears package with that user (see more detailed information in the [appeears package documentation](https://bluegreen-labs.github.io/appeears/articles/appeears_vignette.html).
