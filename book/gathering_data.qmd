...
# for certain API, we could additionally define a query and pass to GET(). 
# for geo.admin this is not supported and details such as date need to 
# be provided through the URL
...
#| code-fold: true
#| label: fig-VHI
#| fig-cap: "Vegetation health index (0-100)"
#| fig-align: "center"
#| out-width: "100%"
...
# # Variant 2) ggplot
# ggplot() +
#   tidyterra::geom_spatraster(data = vhi_07_05) +
